...
To obtain the StripeRust-Net dataset, please download the ![StripeRust-Pocket Dataset User Agreement](https://github.com/WeizhenLiuBioinform/StripeRust-Pocket/blob/master/Dataset/StripeRust-Pocket%20Dataset%20User%20Agreement.docx)
